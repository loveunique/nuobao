package com.nuobao.aop;

import com.nuobao.util.DateUtil;
...
// 引用单个切入点
	...
	public void beforeAdvice(JoinPoint point) {
		...
		logger.info("LoggerHandlerAop.beforeAdvice...time:" + DateUtil.getCurrentDateTime());
	...
	public void afterReturningAdvice() {
		logger.info("LoggerHandlerAop.afterReturningAdvice...time:" + DateUtil.getCurrentDateTime());
	}
	...
	public void afterThrowingAdvice() {
		logger.info("LoggerHandlerAop.afterThrowingAdvice...time:" + DateUtil.getCurrentDateTime());
	}
	...
	public void afterFinallyAdvice() {
		logger.info("LoggerHandlerAop.afterFinallyAdvice...time:" + DateUtil.getCurrentDateTime());
	}
	...
	public Object aroundAdvice(ProceedingJoinPoint pjp) {
		logger.info("LoggerHandlerAop.aroundAdvice...time:" + DateUtil.getCurrentDateTime());
		Object obj = null;
		try {
