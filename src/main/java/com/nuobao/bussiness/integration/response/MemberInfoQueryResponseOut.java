...
public class MemberInfoQueryResponseOut implements Serializable {

    private static final long serialVersionUID = 5327490087671165892L;
    ...
    public String toString() {
        return "MemberInfoQueryResponseOut{" +
