 ...
 *
 * @author Xu Chengzhi
 * @date 2017-09-12 九月 22:07
 * @modify
 **/
public class TranDetailQueryRequestInput implements Serializable {

    private static final long serialVersionUID = 239726200427128814L;
    ...
    public String toString() {
        return "TranDetailQueryRequestInput{" +
                "custNo='" + custNo + '\'' +
                ", bizType='" + bizType + '\'' +
                ", beginDate=" + beginDate +
                ", endDate=" + endDate +
